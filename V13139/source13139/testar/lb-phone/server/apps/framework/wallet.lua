...
ESX.RegisterServerCallback("wallet:getBalance", function(source, phoneNumber)
return GetBalance(source)
end)

---@param page number
---@param recent? true
ESX.RegisterServerCallback("wallet:getTransactions", function(source, phoneNumber, page, recent)
return GetTransactions(phoneNumber, page, recent and 5 or 25)
end)

ESX.RegisterServerCallback("wallet:doesNumberExist", function(source, phoneNumber, number)
...
ESX.RegisterServerCallback("wallet:sendPayment", function(source, phoneNumber, data)
