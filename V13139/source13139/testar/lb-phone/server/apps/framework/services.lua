...
ESX.RegisterServerCallback("services:getOnline", function(_, cb)
...
---@param job string
ESX.RegisterServerCallback("services:getChannelId", function (source, phoneNumber, job)
...
ESX.RegisterServerCallback("services:sendMessage", function(source, phoneNumber, channelId, company, message, anonymous)
if not company or not allowedCompanies[company] then
Citizen.Trace("company not allowed", company, allowedCompanies)
return
end
...
Citizen.Trace("phone:services:sendMessage, company:", company, " message:", message)
...
---@param page? number
ESX.RegisterServerCallback("services:getRecentMessages", function(source, phoneNumber, page)
...
---@param channelId string
---@param page? number
ESX.RegisterServerCallback("services:getMessages", function(source, phoneNumber, channelId, page)
return MySQL.query.await([[
...
---@param channelId string
ESX.RegisterServerCallback("services:deleteChannel", function(source, phoneNumber, channelId)
...
ESX.RegisterServerCallback("services:getEmployees", function(source, phoneNumber, company)
