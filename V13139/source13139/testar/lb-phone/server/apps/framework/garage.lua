...
---@param plate string
ESX.RegisterServerCallback("garage:findCar", function(source, phoneNumber, plate)
...
ESX.RegisterServerCallback("garage:getVehicles", function(source, phoneNumber)
...
ESX.RegisterServerCallback("garage:valetVehicle", function(source, phoneNumber, plate, coords, heading)
...
Citizen.Trace("Failed to create vehicle")
...
Citizen.Trace("Failed to create ped")
return
end
