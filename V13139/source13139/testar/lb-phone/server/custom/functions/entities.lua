...
ESX.RegisterServerCallback("createPhoneObject", function(source, cb, model)
...
Citizen.Trace("Creating phone object for", source)
...
Citizen.Trace(src .. " failed to take control of phone object, deleting it.")
DeleteEntity(entity)
end
end)
