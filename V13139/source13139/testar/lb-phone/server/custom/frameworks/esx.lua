...
Citizen.Trace("Using jg-advancedgarages")
...
Citizen.Trace("Job", jobData.job, "is open:", jobData.open)
end
...
Citizen.Trace(("Job count for job ^5%s^7 changed. Is open: %s"):format(jobData.job, jobData.open))
end)
end
