...
ESX.RegisterServerCallback("services:getManagementEmployees", function(source, phoneNumber, ...)
...
ESX.RegisterServerCallback("services:getBalance", function(source, phoneNumber)
local jobData = oxCore:CallPlayer(source, "getGroupByType", "job")
...
ESX.RegisterServerCallback("services:depositMoney", function(source, phoneNumber, amount)
local jobData = oxCore:CallPlayer(source, "getGroupByType", "job")
...
Citizen.Trace("Failed to deposit money")
end

return oxCore:CallAccount(accountId, "get", "balance") or 0
end)

ESX.RegisterServerCallback("services:withdrawMoney", function(source, phoneNumber, amount)
local jobData = oxCore:CallPlayer(source, "getGroupByType", "job")
...
ESX.RegisterServerCallback("services:hireEmployee", function(source, phoneNumber, targetSource)
...
ESX.RegisterServerCallback("services:fireEmployee", function(source, phoneNumber, identifier)
local jobData = oxCore:CallPlayer(source, "getGroupByType", "job")
...
ESX.RegisterServerCallback("services:setGrade", function (source, phoneNumber, identifier, newGrade)
local jobData = oxCore:CallPlayer(source, "getGroupByType", "job")
